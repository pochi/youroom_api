Gem::Specification.new do |s|
  ...
  s.files = ['History.txt', 'README.txt', 'Manifest.txt', 'Rakefile', 'lib/object_extention.rb', 'lib/youroom_api.rb', 'lib/youroom_api/base.rb', 'lib/youroom_api/base_url.rb','lib/youroom_api/entry.rb','lib/youroom_api/participation.rb','lib/youroom_api/request.rb', 'lib/youroom_api/version.rb','lib/youroom_api/youroom.rb', 'spec/setup_test_model.rb', 'spec/spec.opts','spec/spec_helper.rb','spec/youroom_api/entry_spec.rb','spec/youroom_api/object_extention_spec.rb','spec/youroom_api/participation_spec.rb','spec/youroom_api/request_spec.rb','spec/youroom_api/youroom_spec.rb', 'spec/youroom_api/timeline_spec.rb', 'lib/youroom_api/timeline.rb', 'spec/youroom_api/unread_timeline_spec.rb', 'lib/youroom_api/unread_timeline.rb', 'spec/youroom_api/post_entry_spec.rb', 'lib/youroom_api/post_entry.rb']
